...
<nav className="bg-transparent fixed w-full z-20 top-0 start-0 mb-5">
    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
      
        <span className=" hidden md:block self-center text-2xl font-semibold whitespace-nowrap  text-white dark:text-white">Osasuna</span>
    </a>
    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
       <a href="/admin"> <button type="button" className="text-white bg-[#2D82B7] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button></a>
    ...
    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul className=" horizontalNav flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-3xl md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 glass backdrop-blur-sm">
        ...
        <li className="py-4">
          <a href="/squad" className="px-8  font-medium text-[20px] leading-7 tracking-normal  block text-white  hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Squad</a>
        </li>
        <li className="py-4">
          <a href="/fixtures" className="px-8  font-medium text-[20px] leading-7 tracking-normal  block text-white  hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Fixtures</a>
        </li>
        <li className="py-4">
